...
export class AdministrateursController {
  constructor(
    private readonly administrateursService: AdministrateursService
  ) {}
  ...
  @Patch(":id/status")
  @ApiOperation({ summary: "Mettre à jour le statut d'un administrateur" })
  ...
  updateStatus(
    ...
    return this.administrateursService.updateStatus(id, updateStatusDto.status);
  }
